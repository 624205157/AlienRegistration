...
//        String[] strings = new String[]{android.Manifest.permission.RECORD_AUDIO};
//        if (Build.VERSION.SDK_INT >= 23) {
//            MCamera.this.requestPermissions(strings, 1);
//        }
        languagetype = SPHelper.get(MCamera.this,"languagetype","ch");
        if (languagetype.equals("ch")){
            tv_remind.setText("请在5秒内念出下面数字完成录制");
        }else if(languagetype.equals("en")){
            tv_remind.setText("Please read numbers in 5 seconds to complete");
        }
    }
...
//        String[] strings = new String[]{android.Manifest.permission.RECORD_AUDIO};
//        if (Build.VERSION.SDK_INT >= 23) {
//            MCamera.this.requestPermissions(strings, 0);
//        }
//    }
...
//                        showMsg("超出时间");
                        EndVideoRecord();
                        Intent intent = new Intent(MCamera.this, CheckSubmitActivity.class);
                        intent.putExtra("type", "wgr");
...
//                startActivity(intent);
    ...
    protected void videoRename() {
        String path = Constants.VIDEO_ROOT;
        ...
        SPHelper.put(MCamera.this, Constants.VIDEOPATH, playpath.toString());
