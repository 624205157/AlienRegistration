...
public class MCameraLd extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_video_ld);
        InitViews();
...
//                        showMsg("超出时间");
                        EndVideoRecord();
                        Intent intent = new Intent(MCameraLd.this, CheckSubmitActivity.class);
...
//                startActivity(intent);
    ...
    protected void videoRename() {
        String path = Constants.VIDEOLD_ROOT;
        ...
        SPHelper.put(MCameraLd.this, Constants.VIDEOLDPATH, playpath.toString());
