...
public class PreviewLdActivity extends Activity implements SurfaceHolder.Callback, SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_previewld);
...
//        String playpath= getIntent().getStringExtra("path");
        String playpath = SPHelper.get(PreviewLdActivity.this,Constants.VIDEOLDPATH,"novideo");
        if (StringUtils.isEmpty(playpath) || "novideo".equals(playpath)){
            Toast.makeText(PreviewLdActivity.this,"请先采集人像信息",Toast.LENGTH_SHORT).show();
        }else {
        //网络视频
