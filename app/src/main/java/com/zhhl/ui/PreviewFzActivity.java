...
public class PreviewFzActivity extends Activity implements SurfaceHolder.Callback, SeekBar.OnSeekBarChangeListener, View.OnClickListener {
...
//        String playpath= getIntent().getStringExtra("path");
        String playpath = SPHelper.get(PreviewFzActivity.this,Constants.VIDEOFZPATH,"novideo");
        if (StringUtils.isEmpty(playpath) || "novideo".equals(playpath)){
            Toast.makeText(PreviewFzActivity.this,"请先采集人像信息",Toast.LENGTH_SHORT).show();
        }else {
        //网络视频
