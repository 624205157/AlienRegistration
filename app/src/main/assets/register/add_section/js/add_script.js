...
function nextNa(type,xcyzjlx){
	...
	if(type=='06'){
		 if(xcyzjlx=='s1zqz' || xcyzjlx=='s2zqz' || xcyzjlx=='srswljlxk'){
			// 存储国籍信息
			var gj = "2" ;
			window.location.href="visitedpersonen.html?type="+type+"&xcyzjlx="+xcyzjlx+"&xcyqzUntil="+xcyqzUntil+"&qzyyx="+qzyyx+"&surname="+surname
             +"&givenName="+givenName+"&passportNo="+passportNo+"&njld="+njld+"&ywbh="+ywbh+"&gj="+gj
              +"&birthday="+birthday+"&djdwxzqh="+djdwxzqh;
		}else{
			window.location.href="nationality.html?type="+type+"&xcyzjlx="+xcyzjlx+"&xcyqzUntil="+xcyqzUntil+"&qzyyx="+qzyyx+"&surname="+surname
             +"&givenName="+givenName+"&passportNo="+passportNo+"&njld="+njld+"&ywbh="+ywbh+"&gj="+gj
             +"&birthday="+birthday+"&djdwxzqh="+djdwxzqh;
		}

	}else{
		window.location.href="choose_date.html?type="+type+"&xcyzjlx="+xcyzjlx+"&xcyqzUntil="+xcyqzUntil+"&qzyyx="+qzyyx+"&surname="+surname
        +"&givenName="+givenName+"&passportNo="+passportNo+"&njld="+njld+"&ywbh="+ywbh+"&gj="+gj
        +"&birthday="+birthday+"&djdwxzqh="+djdwxzqh+"&ly="+ly;
	}
...
function nextInp(t){
    ...
    var gj = t  ;
    if(t=='1'){
        window.location.href="visitedpersonch.html?type="+t;
    }else if(t=='2'){
        window.location.href="visitedpersonen.html?type="+t;
    }else{
        window.location.href="visitedpersonforever.html?type="+t;
    }
}
//获取路径中的参数
...
function Check(){
	...
	// }
		...
		$.ajax({
         ...
         btwyxq = $("#btwrzhqx").val();
	        		window.location.href="choose_date.htm?type="+type+"&xcyzjlx="+xcyzjlx+"&xcyqzUntil="+xcyqzUntil+"&qzyyx="+qzyyx+"&surname="+surname
                     +"&givenName="+givenName+"&passportNo="+passportNo+"&njld="+njld+"&ywbh="+ywbh+"&gj="+gj
                     +"&birthday="+birthday+"&djdwxzqh="+djdwxzqh+"&ly="+ly;
	        	 }else{
	        		 alert("没有找到被探望人！");
...
function CheckForever(){
    ...
    if(ins){
      ...
      yjjlz = $("#yjjlzhm").val();
		...
		window.location.href="choose_date.html?btwrzhqx="+$("#btwrzhqx").val()+"sishu="+$("#btwrgx").val()+"btwX="+$("#surname").val()
...
function CheckDate(){
	...
	if($('#sorts').val() == '') {
		alert("在吉停留时限不得不能为空！/The intended duration of stay in Jilin Province must be entered!");
		return false;

	}
	if($('#shenqingshiyou').val() == '' && $('#private').attr('data-state') == 1) {
		alert("申请事由不可以为空！/The reasons for visa application must be entered!");
		return false;
	...
	if((ly == '06')) {
		...
		if(xcyzjlx == 'lzqz'||xcyzjlx == 'mzqz'||xcyzjlx == 'fzqz'||xcyzjlx == 'x1zqz'||xcyzjlx == 'x2zqz') {
            ...
            zjzlzm = "H";
					...
					window.location.href="visa_num.html?zjzl="+'1601'+"yjjlz="+$("#yjjlzhm").val();
					return false;
				}
				if(day>=180&&day<=730){
					if(sishu=="QT"){
						alert("您不符合此证件申请条件，详情请咨询当地公安机关。");
						return false;
					}else{
	        zjzl = "1601";
            nfzjlx = "tjljlxk";
            ...
            nfzjlx_name = "Q2字签证";
            zjzlzm = "H";
					window.location.href="visa_num.html";
					return false;
				}
				if(day>=180&&day<=730){
					if(sishu=="QT"){
		...
		if(xcyzjlx == 's1zqz') {
			if(!getDateDiff(730,180)) {
				alert("该签证，在吉停留时限不得大于730天或小于180天！");
				return false;
			}
			if(sishu=="PO"||sishu=="PODFM"||sishu=="FM"||sishu=="WMZSDZN"){
	        zjzl = "1601";
	...
	if(ly == '46') {
		if(xcyzjlx == 'rzqz') {
			if(!getDateDiff(730,1)) {
				...
				if(day>90&&day<180){
					window.location.href="visa_kind.html";
					return false;
				}else if(day<=90){
        zjzl = "1621";
        nfzjlx = "yqrzqz";
		...
		if(xcyzjlx == 'zzqz') {
			if(!getDateDiff(730,90)) {
			    alert("该签证，在吉停留时限不得大于730天或小于90天！");
			    return false;
			}
        zjzl = "1602";
        nfzjlx = "gzljlxk";
		...
		if(xcyzjlx == 'gzljlxk') {
			if(!getDateDiff(730,90)) {
			    alert("该签证，在吉停留时限不得大于730天或小于90天！/The intended duration of stay shall not be more than 730 days and less than 90 days!");
			    return false;
			}else{
        zjzl = "1602";
        nfzjlx = "gzljlxk";
	...
	if(ly == '07') {
		if(!getDateDiff(1095,180)) {
			alert("该签证，在吉停留时限不得大于1095或小于180天！");
			 return false;
		}
   ...
   var crjbasePath = 'http://221.8.52.247:8445/jit_crj/';
	...
	$.ajax({
		...
		dataType : 'json',
		success: function(data) { //
		location="deal_ways.html?flag="+data+"&ly="+ ly+"&bzsy_type="+zjlx+"&sorts="+Bdate+"&nfzjlx="+nfzjlx+
...
function checkVisaKind(t){
    ...
    $.ajax({
        ...
        dataType : 'json',
         success: function(data) {
             location="deal_ways.html?flag="+data+"&Bdata="+GetQueryString('Bdate');
         }
    });
}
//有效期提示
function dateTips(){
	...
	if((ly == '46')) {
		if(xcyzjlx=='rzqz'){
			$("#tssj").html("在吉停留时限不得大于等于 730，小于等于1天。");
		}
		if(xcyzjlx=='zzqz'){
			$("#tssj").html("在吉停留时限不得大于等于 730，小于等于90天。");
		}
		if(xcyzjlx=='gzljlxk'){
			$("#tssj").html("在吉停留时限不得大于等于 730，小于等于90。");
		}
		tishistr="请问您在吉林省停留多长时间？提示：停留时间(不能超过护照有效期,也不得超过工作许可有效期!)"
	}
	//探亲类
	if((ly == '06')) {
		if(GetQueryString('btwZjhmf')=='1'){
			$("#tsnr").html("您好，您探望的人在华居留期限为"+VALID_UNTIL.substr(0,4)+'年'+VALID_UNTIL.substr(5,2)+'月'+VALID_UNTIL.substr(8,2)+'日'+"。您所选择的居留期限不应大于被探望人！");
		}
		if(xcyzjlx == 's1zqz') {
			$("#tssj").html("在吉停留时限不得大于等于730，   小于等于180天。");
				 if(sishu=="PO"||sishu=="PODFM"||sishu=="FM"||sishu=="WMZSDZN"){
					 $("#tssj").html("在吉停留时限不得大于等于730，   小于等于180天。");
					}else{
					 $("#tssj").html("您不符合此证件申请条件，详情请咨询当地公安机关。");
				}
		}
		if(xcyzjlx == 's2zqz'){
			if(sishu=="PO"||sishu=="PODFM"||sishu=="FM"||sishu=="WMZSDZN"){
		...
		if(xcyzjlx == 'q2zqz'){
			$("#tssj").html("在吉停留时限不得大于等于730，   小于等于1天。");
			if(sishu=="QT"){
				$("#tssj").html("该签证，在吉停留时限不得大于180天！");
			}
		}
    ...
    if(ly == '01') {
	   ...
	   if(xcyzjlx == 'tjljlxk'){
		...
		tishistr="请问您在吉林省停留多长时间？提示：停留时间(不能超过护照有效期,也不得超过学习许可证明有效期!)";
		//$("#tishi").html("请问您在吉林省停留多长时间？提示：停留时间(不能超过护照有效期,也不得超过学习许可证明有效期!)");
    }
	//寄养类
    if(ly == '07') {
	   if(xcyzjlx == 'q1zqz'){
			$("#tssj").html("在吉停留时限不得大于等于1095，   小于等于180天。");
		}
	   if(xcyzjlx == 'q2zqz'){
			$("#tssj").html("在吉停留时限不得大于等于1095，   小于等于180天。");
		}
	   ...
	   tishistr="请问您在吉林省停留多长时间？提示：停留时间(不能超过护照有效期,也不得超过申请人18周岁生日!";
	...
	if(tishistr==''){
		 $("#tssj").prepend("请问您在吉林省停留多长时间？<br/>提示：停留时间不能超过护照有效期！<br/>");
	}else{
		tishistr = tishistr ;
